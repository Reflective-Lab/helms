...
impl OrganizationSummaryPayload {
    fn from_summary(summary: AccountSummary, subscriptions: Vec<OrderSubscription>) -> Self {
        Self {
...
fn experience_event_kind_name(event: &converge_core::ExperienceEvent) -> &'static str {
    match event.kind() {
        ...
        converge_core::ExperienceEventKind::TraceLinkRecorded => "trace-link-recorded",
