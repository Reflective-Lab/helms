...
export type VaultEntryKind = 'directory' | 'note'
...
export type VaultImportReport = {
	imported_root: string
	note_count: number
	attachment_count: number
}

export type AppleNotesImportReport = {
	run_id: string
	imported_root: string
	raw_root: string
	note_root: string
	...
	note_count: number
	attachment_count: number
	reused_note_count: number
	reused_attachment_count: number
	locked_note_count: number
	timed_out_note_count: number
}

export type AppleNotesPublishReport = {
	run_id: string
	published_at: string
...
export type WebSnapshotCaptureReport = {
	run_id: string
	raw_root: string
	manifest_path: string
...
export type NoteCleanupReport = {
	run_id: string
	enriched_root: string
	report_path: string
	note_count: number
	exact_duplicate_group_count: number
	similarity_candidate_count: number
...
export type NoteFreshnessStatus = 'current' | 'aging' | 'stale' | 'unknown'

export type NoteValueAction = 'keep' | 'promote' | 'refresh' | 'demote'

export type NoteValueCandidate = {
	path: string
	title: string
	kind: string
	provenance: string
	...
	suggested_action: NoteValueAction
	overall_score_bps: number
	freshness_score_bps: number
	value_score_bps: number
	age_days?: number
	inbound_reference_count: number
	outgoing_reference_count: number
	external_url_count: number
	reasons: string[]
}

export type NoteValueReport = {
	run_id: string
	enriched_root: string
	report_path: string
	details_path: string
	...
	aging_note_count: number
	stale_note_count: number
	unknown_freshness_note_count: number
	promote_candidate_count: number
	refresh_candidate_count: number
	demote_candidate_count: number
	promote_candidates: NoteValueCandidate[]
	refresh_candidates: NoteValueCandidate[]
	demote_candidates: NoteValueCandidate[]
}
